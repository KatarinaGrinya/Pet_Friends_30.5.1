...
driver = webdriver.Chrome(executable_path="C:\\Users\\GrickevichK\\PycharmProjects\\30.5.1\\chromedriver.exe")

@pytest.fixture(autouse=True, scope="session")
def testing():
    pytest.driver = webdriver.Chrome('C:\\Users\\GrickevichK\\PycharmProjects\\30.5.1\\chromedriver.exe')
